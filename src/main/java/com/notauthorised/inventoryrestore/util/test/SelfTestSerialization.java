package com.notauthorised.inventoryrestore.util.test;

import com.notauthorised.inventoryrestore.InventoryRestore;
import com.notauthorised.inventoryrestore.util.serialization.DeserializationResult;
import com.notauthorised.inventoryrestore.util.serialization.Version2Serialization;
...
public class SelfTestSerialization {
    ...
    public static void runTests() {
        ...
        MCVersion currentVersion = InventoryRestore.getInstance().getVersion().getMcVersions()[0];
        ...
        Logger logger = InventoryRestore.getInstance().getLogger();
