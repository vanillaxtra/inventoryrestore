...
public class PlayerMenu {
    ...
    public void createInventory() {
        ...
        inventory.setItem(7, buttons.createCrashLogButton(LogType.CRASH, null));
    }
    ...
    public void getPlayerMenu() {
        ...
        List<String> crashes = Arrays.asList(crashBackup.getAmountOfBackups() + backupsAvailable);
        inventory.setItem(7, buttons.createCrashLogButton(LogType.CRASH, crashes));
    }
